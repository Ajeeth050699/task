...
import img12 from "./images/icons8-instagram-verification-badge-48.png";
import img13 from "./images/icons8-twitter-24.png";
import img11 from "./images/icons8-todo-list-24.png";
import img15 from "./images/icons8-share-30.png";
import img14 from "./images/icons8-christmas-star-50.png";
import img16 from "./images/icons8-ellipsis-50.png";
    ...
    <div className="App">
      ...
      <div className="description">
        <div className="headings">
          <div className="head1">
            BEANZ Official
            <img src={img12} className="tick"></img>
          </div>
          <div className="twitts-titles">
            <img src={img13} className="tick"></img>
            <div className="line2"></div>
            <img src={img14} className="tick"></img>
            <img src={img15} className="tick"></img>
            <img src={img16} className="tick"></img>
          </div>
        </div>
        <div className="head2">
          By
          <span className="desp">
            TeamAzuki <img src={img12} className="tick1"></img>
          </span>
        </div>
        <div className="head2">
          Items
          ...
          <span className="dot"></span>· Creator earnings
          <span className="desp">5%</span>
          <span className="dot"></span>· Chain
        ...
        <div className="head2">
          ...
          They make for a great sidekick to an Azuki...
        </div>
        ...
        <div className="h4">
          <div className="">
            <img src={img10} className="img1"></img>{" "}
          </div>
          ...
          <div className="">
            <select className="search2">
              <option value="price1">price high to low</option>
              <option value="price2">price low to high</option>
              <option value="price3">Recently solded</option>
              <option value="price4">high performance</option>
            </select>
          </div>
          <div className="box">
            <img src={img11} className="img2"></img>
